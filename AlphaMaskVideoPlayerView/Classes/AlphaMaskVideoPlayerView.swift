...
open class AlphaMaskVideoPlayerView: GLKView, AlphaMaskVideoPlayerUpdateDelegate {.init
  private lazy var ciContext: CIContext = .init(eaglContext: context, options: [kCIContextWorkingColorSpace : NSNull(), kCIContextCacheIntermediates : false])
